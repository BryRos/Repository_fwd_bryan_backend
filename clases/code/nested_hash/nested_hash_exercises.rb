def find_language_information(languages, language_name)
  ...
  p find_language_information(language, :ruby)
...
p add_information_about_language(expected_output, :ruby, :is_beautiful?, :true )
...
p add_language(hash_3, :java, value_to_add)
...
delete_information_about_language(hash_4, :ruby, :is_beautiful?)
...
def find_beautiful_languages(languages)
  ...
  languages.select {|language_name, language_info| 
...
def find_language_facts(languages, language_name, fact_index = 0)
  ...
  p find_language_facts(lang, :ruby, 1)